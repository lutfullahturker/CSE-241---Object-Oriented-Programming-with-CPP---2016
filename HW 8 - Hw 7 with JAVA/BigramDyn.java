...
public class BigramDyn<T> implements Bigram<T>{
        ...
        switch (dataType)
        {
            case 1: 
                ...
                {// temp tutup dosyadan okuduklarımızı tempe yazıp tempten aktarıyoruz.
                    ...
                    if (size >= capacity)
                    { // kapasite yetmediğinde yeri artırıyoruz. 
                        Object[] tempArr =(T[])new Object[capacity +10];
    ...
    {// for döngüsü ile girilen sayıdan kaç tane olduğunu hesaplayıp return ediyoruz.
        ...
        {
            if (bigram[i].equals(first) && bigram[i+1].equals(second))
                count ++;
        }
        return count;
    }
    ...
    public String toString() 
    {
        ...
        for (int i=0;i<size-1;++i)
        {
            ...
            bigramArr[i].setLeft((T)bigram[i]);
            bigramArr[i].setRight((T)bigram[i+1]);
